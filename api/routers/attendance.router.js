...
break;
    ...
    break;
      ...
      } const compensation=await requestsModel.find({ $and:[{from:result[i].staffId},{type:  'compensation leave'},{status: 'accepted'}]});
      console.log(result[i].staffId+comp);
      console.log(compensation+comp);
      if(compensation){
        console.log(compensation+"copp")
